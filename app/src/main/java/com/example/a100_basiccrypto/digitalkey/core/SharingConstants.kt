...
object SharingConstants {
    ...
    const val OFFSET_SIGNATURE = 62

    const val METADATA_SIZE = 62 // Total bytes before Signature

    // --- PERMISSION BITS (Uint32 Bitmask) ---
    ...
    const val PERM_WINDOWS = 0x00000020
    const val PERM_FULL    = -0x80000000 // 0x80000000 as Signed Int
}
